...
struct SuperpositionDebugContext {
    int layerIdx = -1;
    int numLayers = 0;
    float energy = 0.0f;
    float energyIdx = 0.0f;
    float peakDepthMm = 0.0f;
    float layerCutoffMm = 0.0f;
    int originalRayDimsX = 0;
    int originalRayDimsY = 0;
    int superpRayDimsX = 0;
    int superpRayDimsY = 0;
    float meanVoxelWidthFirstMm = 0.0f;
    float meanVoxelWidthMidMm = 0.0f;
    float meanVoxelWidthLastMm = 0.0f;
    float sigmaAtRad32FirstMm = 0.0f;
    float sigmaAtRad32MidMm = 0.0f;
    float sigmaAtRad32LastMm = 0.0f;
    float spotSigmaXmm = 0.0f;
    float spotSigmaYmm = 0.0f;
    float profileRowIdx = 0.0f;
    const float* devBevCumulSp = nullptr;
    const float* devBevDensity = nullptr;
    float rangeStopDepthMm = 0.0f;
    float stepVolConst = 0.0f;
    float stepVolLin = 0.0f;
    float stepVolSq = 0.0f;
};
...
void performPrimaryTileBasedSuperposition(
    ...
    const SuperpositionDebugContext* debugContext = nullptr
);
