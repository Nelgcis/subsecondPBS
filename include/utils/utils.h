/**
 * \file
 * \brief Utility Functions for RTD Integration
 * 
...
// Helper-created textures are array-backed and must be released with
// destroyTextureObjectAndArray(...) to free both the texture object and
// its backing cudaArray.
